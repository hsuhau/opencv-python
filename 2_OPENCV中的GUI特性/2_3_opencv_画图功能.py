...
# 厚度：线或圆等的粗细。如果对闭合图形（如圆）传递-1_OPENCV安装 ，它将填充形状。默认厚度= 1_OPENCV安装
...
# 画矩形
# 要绘制矩形，您需要矩形的左上角和右下角。这次，我们将在图像的右上角绘制一个绿色矩形。 cv.rectangle(img,(384,0),(510,128),(0,255,0),3)
#
# 画圆圈
# 要绘制一个圆，需要其中心坐标和半径。我们将在上面绘制的矩形内绘制一个圆。 cv.circle(img,(447,63), 63, (0,0,255), -1_OPENCV安装)
#
# 画椭圆
